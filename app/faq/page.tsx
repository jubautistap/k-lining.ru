...
export const metadata: Metadata = {
  ...
  description: 'Ответы на популярные вопросы о клининговых услугах в Москве. Цены, качество, гарантии, сроки выполнения работ. K-lining - профессиональная уборка квартир и офисов.',
  keywords: 'FAQ клининг, вопросы уборка, цены клининг москва, гарантии уборка, сроки клининг, качество уборка, отзывы клининг',
  openGraph: {
    title: 'FAQ - Часто задаваемые вопросы о клининге | K-lining',
    description: 'Ответы на популярные вопросы о клининговых услугах в Москве. Цены, качество, гарантии.',
    type: 'website',
    siteName: 'K-lining',
  },
  twitter: {
...
const faqData = [
  {
    ...
    answer: 'Стоимость уборки квартиры зависит от площади, количества комнат и типа уборки. Базовая уборка 1-комнатной квартиры от 2,500₽, генеральная уборка от 4,500₽. Точную стоимость рассчитываем индивидуально после осмотра помещения.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Да, у нас есть полная страховка ответственности на сумму 1,000,000₽. Это покрывает любые возможные повреждения имущества во время уборки. За 5 лет работы не было ни одного страхового случая.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Да, у нас более 500 положительных отзывов на различных площадках. Можем предоставить контакты наших клиентов для получения рекомендаций. Также публикуем отзывы в соцсетях и на сайте.'
  }
];
