...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'FAQ - Часто задаваемые вопросы о клининге | K-lining',
    description: 'Ответы на популярные вопросы о клининговых услугах в Москве. Цены, качество, гарантии. Мин. заказ — 6 000 ₽; услуги от 2 500 ₽.',
    type: 'website',
    siteName: 'K-lining',
  },
  twitter: {
...
const faqData = [
  {
    ...
    answer: 'Минимальная стоимость заказа — 6,000₽. Отдельные услуги начинаются от 2,500₽. Итог зависит от площади, типа уборки и доп. услуг. Точную стоимость покажет калькулятор на сайте или смета после осмотра.'
  },
  {
