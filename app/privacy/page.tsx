...
export const metadata: Metadata = {
  title: 'Политика конфиденциальности | KliningPro',
  description: 'Политика конфиденциальности KliningPro. Как мы собираем, используем и защищаем вашу персональную информацию.',
  robots: {
    index: false,
    follow: false,
  },
      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Настоящая Политика конфиденциальности описывает, как компания KliningPro собирает, 
