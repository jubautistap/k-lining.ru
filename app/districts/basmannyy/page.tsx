...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная уборка квартир и офисов в Басманном районе ⭐ Офис на Бакунинской 69 стр 1 ⭐ Быстрый выезд, работаем 24/7 ⭐ Химчистка, генеральная уборка ⭐ Минимальный заказ — 6,000₽',
