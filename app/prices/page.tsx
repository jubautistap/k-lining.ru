...
export const metadata: Metadata = {
  title: 'Цены на уборку в Москве 2025 — мин. заказ 6 000 ₽; услуги от 2 500 ₽ | K-lining',
  description: 'Прозрачные цены на клининговые услуги в Москве. Уборка квартир, домов, офисов, химчистка, мытьё окон. Никаких скрытых доплат. Актуальные цены 2025 года.',
  ...
  openGraph: {
    ...
    description: 'Актуальные цены на профессиональную уборку квартир и офисов в Москве. Прозрачное ценообразование, без скрытых доплат. Услуги от 2,500₽; минимальный заказ — 6,000₽.',
