        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">Стоимость зависит от площади офиса, графика и требований. Регулярная уборка 80–110 ₽/м²; генеральная 100–140 ₽/м². Минимальный заказ — 6 000 ₽.</p>
            </div>
