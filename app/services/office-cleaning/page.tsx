...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная уборка офисов и коммерческих помещений в Москве. Ежедневная уборка, генеральная уборка, уборка после ремонта. Дезинфекция, мытьё окон. Услуги от 3 000₽. Мин. заказ — 6 000 ₽.',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Почему выбирают K-lining для уборки офисов?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
