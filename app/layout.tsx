...
export const metadata: Metadata = {
  title: {
    default: 'Уборка в Москве — мин. заказ 6 000 ₽; услуги от 2 500 ₽ | K-lining 24/7',
    template: '%s | K-lining'
  },
  description: 'Профессиональная уборка квартир и офисов в Москве 24/7 ⭐ Клининговая компания K-lining ⭐ Химчистка мебели, мытьё окон, генеральная уборка, уборка после ремонта ⭐ Минимальный заказ — 6,000₽; услуги — от 2,500₽ ⭐ Выезд в любой район Москвы и МО',
