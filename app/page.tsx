...
export const metadata: Metadata = {
  title: 'Уборка квартир и офисов в Москве 24/7 — от 2 500 ₽ | K-lining',
  ...
  openGraph: {
    ...
    description: 'Профессиональная уборка квартир и офисов в Москве ⭐ Клининговая компания K-lining ⭐ Химчистка мебели, мытье окон, генеральная уборка ⭐ Работаем круглосуточно без выходных ⭐ Честные цены от 2,500₽ ⭐ Выезд в любой район Москвы и МО',
