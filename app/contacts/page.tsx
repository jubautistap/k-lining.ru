...
export const metadata: Metadata = {
  ...
  description: 'Контакты K-lining Москва: заказать уборку по телефону +7(925)555-18-33. Работаем 24/7, бесплатная консультация, выезд за 2 часа ☎',
  keywords: 'клининговая компания москва, контакты уборка, заказать уборку',
  openGraph: {
